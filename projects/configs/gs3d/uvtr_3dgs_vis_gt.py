...
unified_voxel_size = [0.4, 0.4, 0.4]
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        in_channels=128,
        use_semantic=True,
        vis_gt=True,  ## NOTE: for debug only
...
data = dict(
    ...
    train=dict(
        ...
        data_root=data_root,
        ann_file=data_root
        + "nuscenes_unified_infos_train_occ.pkl",  # please change to your own info file
    ...
    val=dict(
        ...
        classes=class_names,
        modality=input_modality,
        ann_file=data_root + "nuscenes_unified_infos_val_occ.pkl",
        load_interval=1,
